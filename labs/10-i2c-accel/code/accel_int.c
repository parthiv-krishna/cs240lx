...
void accel_int_wom_enable(unsigned addr) {
    ...
    // gpio_int_rising_edge(21);
    gpio_int_falling_edge(21);


    imu_wr(addr, 0x6B, 0);
    delay_ms(50);
    imu_wr(addr, 0x6C, 0b11000111);
    delay_ms(50);
    imu_wr(addr, 0x1D, 0b1);
    delay_ms(50);
    imu_wr(addr, 0x38, 0x40);
    delay_ms(50);
    imu_wr(addr, 0x69, 0b11 << 6);
    delay_ms(50);
    imu_wr(addr, 0x1F, 128);
    delay_ms(50);
    imu_wr(addr, 0x1E, 4);
    delay_ms(50);
    imu_wr(addr, 0x6B, 1 << 5);
    delay_ms(50);
